				...
				<div class="span12">
					<div class="form-container grid-form form-background left-align form-horizontal">
						<form action="" method="get" id=''>
							...
							<div class="control-group">
								<label for="name" class="control-label">标签管理权限：</label>
								<div class="controls">
									<label><input id="role1" type="checkbox"  value="yes" />标签管理权限： </label> 
								</div>
							</div>
							<div class="control-group">
								<label for="name" class="control-label">照片审核权限：</label>
								<div class="controls">
									<label><input id="role2" type="checkbox" value="yes" />照片审核权限： </label> 
								</div>
							</div>
							
							<div class="control-group">
								<label for="name" class="control-label">注册用户管理权限：</label>
								<div class="controls">
									<label><input id="role3" type="checkbox" value="yes" />注册用户管理权限： </label> 
								</div>
							</div>
							<div class="control-group">
								<label for="name" class="control-label">管理员管理权限：</label>
								<div class="controls">
									<label><input id="role4" type="checkbox" value="yes" />管理员管理权限： </label> 
								</div>
							</div>
						</form>
					</div>
