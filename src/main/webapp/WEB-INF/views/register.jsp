        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <form  action="doregister" method="post">
                <div class="form-group ">
                    ...
                    <input type="text" class="form-control input-lg" id="username" name="user.name" placeholder="用户名" >
                </div>
                <div class="form-group">
                    <label for="password">密码</label>
                    <input type="password" class="form-control input-lg" id="password" name="user.password" >
                    <div class="help-block with-errors"></div>
                </div>
                
                 <div class="form-group ">
                    <label for="nickname">昵称</label>
                    <input type="text" class="form-control input-lg" id="nickname" name="user.nickname" placeholder="用户名" >
                </div>
                
                <div class="form-group">
                       <label for="address">地址</label>
                    <input type="text" class="form-control input-lg" id="address" name="user.address" placeholder="地址" >
                </div>
                <div class="form-group">
                       <label for="email">邮箱</label>
                    <input type="text" class="form-control input-lg" id="email" name="user.email" placeholder="邮箱" >
                </div>
